...
<body class="bg-gray-100">
    <div class="container mx-auto p-4 flex justify-center">
        <div class="w-4/6">
            <div class="bg-primary p-3 text-white rounded-t-xl border-2 font-bold flex flex-row min-w-[490px]">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg min-w-[490px]">
                ...
                <div class="text-left mb-4 ml-10">
                ...
                <div class="flex justify-between mt-8 space-x-10 ml-10">
                    <div class="text-center">
                        <p>Lang-Lang, 12 Maret 2024<br>Mengetahui</p>
                        <p class="mt-8">Ketua RW 01<br><br><br><br>SUDIONO</p>
                    </div>
                        <div class="text-left space-x-10 ml-10">
                            <p><br>Mengetahui</p>
                            <p class="text-left mt-8 space-x-10 ml-10">Ketua RW 01<br><br><br><br>SUDIONO</p>
                        </div>
                </div>
            </div>
