...
<head>
    ...
    <title>Riwayat | Pelaporan Tamu</title>
    ...
    <div class="bg-[#FFFFFF] flex flex-col items-center w-[1300px] box-sizing-border">
        ...
        <div class="m-[0_105.5px_50px_107.5px] flex box-sizing-border">
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col items-center p-[0_0_14px_0] box-sizing-border">
            <div class="border-b-[1px_solid_#EBEBEB] bg-[#2A6C12] m-[0_0_15px_0] flex flex-row p-[16px_0_15px_20px] w-[1087px] box-sizing-border">
              ...
              <div class="m-[4px_0_5px_0] flex box-sizing-border">
                <span class="break-words font-'SF_Pro_Display','Roboto_Condensed' font-semibold text-[20px] text-[#FFFFFF]">
                  Riwayat pelaporan tamu
                </span>
              </div>
            </div>
            <div class="m-[0_50px_0_28px] flex flex-col items-center w-[1007px] box-sizing-border">
              <div class="m-[0_0_15px_0] flex flex-row justify-between w-[1007px] box-sizing-border">
                <div class="shadow-[0px_0px_60px_5px_rgba(226,236,249,0.5)] rounded-[25px] border-[1px_solid_#CECECE] bg-[#FFFFFF] relative flex flex-row p-[14px_0_17.4px_26px] w-[295px] box-sizing-border">
                  <img class="m-[3.2px_13px_0_0] w-[13px] h-[14.1px]" src="../icon/search.svg" />
              ...
              <div class="m-[0_2px_0_0] flex flex-row w-[1005px] box-sizing-border">
                <div class="border-l-[1px_solid_#CFD7F2] border-b-[1px_solid_#CFD7F2] bg-[#FFFFFF] flex flex-col items-center p-[0_0_19px_0] w-[335px] box-sizing-border">
                  <div class="bg-[#9AE4A1] m-[0_0_20px_0] flex p-[15px_0_15px_0] w-[335px] box-sizing-border justify-center">
                ...
                <div class="border-l-[1px_solid_#CFD7F2] border-b-[1px_solid_#CFD7F2] bg-[#FFFFFF] flex flex-col items-center p-[0_0_19px_0] w-[335px] box-sizing-border">
                  ...
                  <div class="rounded-[6px] m-[0_1px_0_0] flex box-sizing-border">
                    <span class="break-words font-Asap font-normal text-[16px] text-[#000000]">
                      Silfi Nazarina
                    </span>
                  </div>
                </div>
                <div class="border-r-[1px_solid_#CFD7F2] border-b-[1px_solid_#CFD7F2] bg-[#FFFFFF] flex flex-col items-center p-[0_0_19px_0] w-[335px] box-sizing-border">
                  <div class="bg-[#9AE4A1] m-[0_0_20px_0] flex p-[15px_0_15px_0] w-[335px] box-sizing-border justify-center">
                    <span class="break-words font-Asap font-medium text-[16px] tracking-[0.9px] uppercase text-[#000000]">
                      KETERANGAN
                    </span>
                  </div>
                  <div class="rounded-[6px] m-[0_0_0_1px] flex box-sizing-border">
                    <span class="break-words font-Asap font-normal text-[16px] underline text-[#000000]">
                      Rincian
                    </span>
                  </div>
                </div>
