...
<head>
    ...
    <title>Struktur Kepemimpinan</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
    <div class="bg-[#FFFFFF] flex flex-col items-center w-[1300px] box-sizing-border">
        <div class="bg-[url('../img/desa-lang2.png')] bg-[50%_50%] bg-cover bg-no-repeat relative m-[0_0_70px_0] w-[1300px] h-[427px]">
        ...
        <div class="m-[0_10px_50px_12px] flex flex-col items-center w-[fit-content] box-sizing-border">
          <div class="m-[0_0_46.3px_0] flex flex-col items-center w-[fit-content] box-sizing-border">
            <div class="m-[0_0_2.7px_0.4px] inline-block break-words font-Poppins font-bold text-[17px] leading-[1.412] text-[#2A6C12]">
              Pemimpin
            </div>
            <span class="break-words font-Poppins font-bold text-[32px] leading-[1.3] text-[#232428]">
              Struktur Kepemimpinan RW 01 beserta RT
            </span>
          </div>
          <div class="m-[0_87.5px_25px_87.5px] flex flex-col items-center w-[fit-content] box-sizing-border">
            <div class="m-[0_0_25px_0] flex flex-row gap-[0_25px] w-[fit-content] box-sizing-border">
                <div class="rounded-[12px] relative flex flex-col justify-end p-[0_0_20.4px_30px] w-[351px] h-[340px] box-sizing-border bg-[linear-gradient(0deg,#2A6C12)]">
                    <img src="../img/do-png.png" alt="gambar" class="absolute inset-0 w-full h-full rounded-[12px] object-cover">
                    <div class="relative m-[0_0_6.6px_0] inline-block self-start break-words font-Poppins font-normal text-[16px] leading-[1.219] text-[#FFFFFF] z-10">
                        Kepala Desa
                    </div>
                    <span class="relative self-start break-words font-Poppins font-bold text-[21px] leading-[1.3] text-[#FFFFFF] z-10">
                        Yulianto
                    </span>
                </div>                               
                <div class="rounded-[12px] relative flex flex-col justify-end p-[0_0_20.4px_30px] w-[351px] h-[340px] box-sizing-border bg-[linear-gradient(0deg,#2A6C12)]">
