    ...
    <div class="bg-[#FFFFFF] flex flex-col items-center w-[1300px] box-sizing-border">
        <div class="bg-[url('../img/desa-lang2.png')] bg-[50%_50%] bg-cover bg-no-repeat relative m-[0_0_50px_0] w-[1300px] h-[427px]">
          ...
          <div class="absolute left-[110px] top-[32.3px] right-[110px] flex flex-col items-end box-sizing-border">
            ...
            <div class="flex flex-col w-[fit-content] box-sizing-border">
              ...
              <div class="flex flex-col items-center self-start w-[fit-content] box-sizing-border">
                <div class="m-[0_7.2px_15px_0] flex flex-row w-[fit-content] box-sizing-border">
        ...
        <div class="m-[0_105.5px_50px_107.5px] flex box-sizing-border">
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col items-center p-[0_0_14px_0] box-sizing-border">
            <div class="border-b-[1px_solid_#EBEBEB] bg-[#2A6C12] m-[0_0_15px_0] flex flex-row p-[16px_0_15px_29px] w-[1087px] box-sizing-border">
              ...
              <div class="m-[4.5px_0_4.5px_0] inline-block break-words font-Asap font-normal text-[20px] text-[#FFFFFF]">
                Rincian Data Diri
              </div>
            </div>
            <div class="m-[0_63.5px_0_63.5px] flex flex-row w-[958px] box-sizing-border">
                <div class="bg-[url('../img/do-png.png')] bg-cover m-[0_50px_0_0] w-[351px] h-[340px]"></div>
                <div class="m-[92px_0_92px_0] flex flex-col items-center w-[557px] h-[fit-content] box-sizing-border">
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row justify-start p-[8px_0_8px_0] w-[557px] box-sizing-border">
                    <span class="m-[0_12px_0_0] w-[143px] break-words font-Asap font-normal text-[20px] leading-[1.2] text-[#232428]">
                        Nama        :
                    </span>
                    <span class="break-words font-Asap font-bold text-[20px] leading-[1.2] text-[#232428]">
                        Sudiono
                    </span>
                </div>
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row justify-start p-[8px_0_8px_0] w-[557px] box-sizing-border">
                ...
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row justify-start p-[8px_0_8px_0] w-[557px] box-sizing-border">
                  <span class="m-[0_12px_0_0] w-[140px] break-words font-Asap font-normal text-[20px] leading-[1.2] text-[#232428]">
                    No. telp          :
                  </span>
                ...
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row justify-start p-[8px_0_8px_0] w-[557px] box-sizing-border">
                  <span class="m-[0_12px_0_0] w-[139px] break-words font-Asap font-normal text-[20px] leading-[1.2] text-[#232428]">
                    Alamat           :
                  </span>
                  <span class="break-words font-Asap font-bold text-[20px] leading-[1.2] text-[#232428]">
                    Lang-Lang 1 RT 04, RW 01, No. 01
                  </span>
                </div>
              </div>
            </div>
