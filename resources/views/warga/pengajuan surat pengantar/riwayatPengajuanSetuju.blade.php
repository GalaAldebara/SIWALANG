...
<head>
    ...
    <title>Riwayat | Pengajuan Surat Pengantar</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
    <div class="bg-[#FFFFFF] flex flex-col items-center w-[1300px] box-sizing-border">
        <div class="bg-[url('../img/desa-lang2.png')] bg-[50%_50%] bg-cover bg-no-repeat relative m-[0_0_50px_0] w-[1300px] h-[427px]">
        ...
        <div class="m-[0_105.5px_50px_107.5px] flex box-sizing-border">
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col items-center p-[0_0_14px_0] box-sizing-border">
            <div class="border-b-[1px_solid_#EBEBEB] bg-[#2A6C12] m-[0_0_15px_0] flex flex-row p-[16px_0_15px_25px] w-[1087px] box-sizing-border">
            ...
            <div class="m-[0_31px_15px_28px] flex flex-row justify-between w-[1026px] box-sizing-border">
              <div class="shadow-[0px_0px_60px_5px_rgba(226,236,249,0.5)] rounded-[25px] border-[1px_solid_#CECECE] bg-[#FFFFFF] relative flex flex-row p-[14px_0_17.4px_27.2px] w-[295px] box-sizing-border">
                <img class="m-[3.2px_11.5px_0_0] w-[13.3px] h-[14.1px]" src="../icon/search.svg" />
                <div class="m-[0_0_1.3px_0] inline-block break-words font-Asap font-normal text-[14px] tracking-[-0.1px] text-[#7E7E7E]">
                  Search
                </div>
              </div>
              <div class="m-[6.3px_0_6.3px_0] flex box-sizing-border">
                <div class="rounded-[4px] bg-[#28A745] flex p-[6px_12px_6px_12px] box-sizing-border">
                  <span class="break-words font-Asap font-medium text-[16px] leading-[1.5] text-[var(--global-09-white,#FFFFFF)]">
                    +  Buat Laporan
                  </span>
                </div>
              </div>
            </div>
            <div class="m-[0_28px_0_28px] flex flex-row w-[1029px] box-sizing-border">
              <div class="border-l-[1px_solid_#CFD7F2] border-b-[1px_solid_#CFD7F2] bg-[#FFFFFF] flex flex-col items-center p-[0_0_19px_0] w-[343px] box-sizing-border">
                <div class="bg-[#9AE4A1] m-[0_0_20px_0] flex p-[13.5px_0_13.5px_0] w-[343px] box-sizing-border justify-center">
                  <span class="break-words font-Asap font-medium text-[16px] tracking-[0.9px] uppercase text-[#000000]">
                    Tanggal PENGAJUAN
                  </span>
                </div>
                <div class="rounded-[6px] m-[0_1px_0_0] flex box-sizing-border justify-center">
                  <span class="break-words font-Asap font-normal text-[16px] text-[#000000]">
                    12/08/2024
                  </span>
                </div>
              </div>
              <div class="border-b-[1px_solid_#CFD7F2] bg-[var(--style,#FFFFFF)] flex flex-col items-center p-[0_0_16px_0] w-[343px] box-sizing-border">
                <div class="bg-[#9AE4A1] m-[0_0_14px_0] flex p-[13px_0_13px_0] w-[343px] box-sizing-border justify-center">
                  <span class="break-words font-Inter font-medium text-[16px] tracking-[0.9px] uppercase text-[#000000]">
                    Status
                  </span>
                </div>
                <div class="flex box-sizing-border">
                  <div class="rounded-[10px] bg-[#D4EDDA] flex p-[4px_12.5px_4px_12px] box-sizing-border justify-center">
                    <span class="break-words font-Inter font-medium text-[16px] tracking-[0.9px] capitalize text-[#155724]">
                      Disetujui
                    </span>
                  </div>
                </div>
              </div>
              <div class="border-r-[1px_solid_#CFD7F2] border-b-[1px_solid_#CFD7F2] bg-[#FFFFFF] relative flex p-[0_0_57px_0] w-[343px] box-sizing-border">
                <div class="bg-[#9AE4A1] flex p-[13.5px_0_13.5px_0] w-[343px] h-[fit-content] box-sizing-border justify-center">
                  <span class="break-words font-Asap font-medium text-[16px] tracking-[0.9px] uppercase text-[#000000]">
                    aksi
                  </span>
                </div>
                <div class="absolute left-[101.5px] bottom-[10.7px] flex flex-row box-sizing-border">
                  <div class="rounded-[8px] bg-[#17A2B8] m-[0_5px_0_0] flex p-[10px_10px_10px_10px] box-sizing-border justify-center">
                    <span class="break-words font-Asap font-medium text-[14px] text-[#FFFFFF]">
                      Rincian
                    </span>
                  </div>
                  <div class="rounded-[8px] bg-[#FFC107] flex p-[10px_10px_10px_10px] box-sizing-border justify-center">
                    <span class="break-words font-Asap font-medium text-[14px] text-[#000000]">
                      Cetak
                    </span>
                  </div>
                </div>
