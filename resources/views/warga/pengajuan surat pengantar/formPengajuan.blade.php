...
<head>
    ...
    <title>Form | Pengajuan Surat Pengantar</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
    <div class="bg-[#FFFFFF] flex flex-col w-[1300px] box-sizing-border">
          ...
          <div class="absolute left-[110px] top-[32.3px] right-[110px] flex flex-col items-end box-sizing-border">
            ...
            <div class="flex flex-col w-[fit-content] box-sizing-border">
              ...
              <div class="flex flex-col self-start w-[fit-content] box-sizing-border">
                <div class="m-[0_0_15px_0] flex flex-row w-[fit-content] box-sizing-border">
                ...
                <span class="self-start break-words font-Poppins font-bold text-[37px] leading-[1.297] text-[#FFFFFF]">
                  Pangajuan Surat
                </span>
              </div>
            </div>
        ...
        <div class="m-[0_105.5px_50px_107.5px] box-sizing-border">
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col box-sizing-border">
            ...
            <div class="bg-[#FFFFFF] flex flex-col p-[30px_27px_30px_27px] w-[fit-content] box-sizing-border">
              ...
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="no-ktp-nik-sub-23"></span>
              ...
              <div class="m-[0_2.5px_30px_2.5px] flex flex-row w-[fit-content] box-sizing-border">
                <div class="m-[0_20px_0_0] flex flex-col w-[488px] box-sizing-border">
                  <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                    <span class="tempat-lahir-sub-23"></span>
                ...
                <div class="flex flex-col box-sizing-border">
                  <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                    <span class="tanggal-lahir-sub-23"></span>
                    <span>Tanggal Lahir</span>
                  </p>
                  <div class="rounded-[8px] border-[1px_solid_#EBEBEB] bg-[#FFFFFF] flex flex-row justify-between p-[13px_15.6px_13px_15px] w-[520px] box-sizing-border">
                    <span class="m-[0_11.5px_0_0] w-[461.5px] break-words font-Asap font-normal text-[20px] text-[#232428]">
                      12/04/2003
                    </span>
                    <div class="m-[3.5px_0_3.5px_0] flex w-[14.4px] h-[16px] box-sizing-border">
                      <img class="w-[14.4px] h-[16px]" src="../icon/kalender.svg" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="jenis-kelamin-sub-23"></span>
              ...
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="status-perkawinan-sub-23"></span>
              ...
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="pekerjaan-sub-23"></span>
                  <span>Pekerjaan</span>
                </p>
                <div class="rounded-[8px] border-[1px_solid_#EBEBEB] bg-[#FFFFFF] p-[13px_15px_13px_15px] w-[fit-content] box-sizing-border">
                  <span class="break-words font-Asap font-normal text-[20px] text-[#AFAFAF]">
              ...
              <div class="flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="keperluan-pengajuan-sub-23"></span>
                ...
                <div class="rounded-[8px] border-[1px_solid_#EBEBEB] bg-[#FFFFFF] flex flex-row justify-between p-[13px_22px_13px_15px] w-[1033px] box-sizing-border">
                  <span class="m-[0_11.5px_0_0] w-[972.5px] break-words font-Asap font-normal text-[20px] text-[#AFAFAF]">
                    Pilih keperluan pengajuan
                  </span>
