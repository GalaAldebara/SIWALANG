                ...
                <div class="w-full my-4 px-6" style="font-family: Asap">
                    <div class="mb-3">
                        ...
                        <div class="mt-2 w-full">
                            <input id="nama" name="nama" type="text" placeholder="Masukkan nama anda" class="w-full rounded-md border py-1 px-4 text-gray-900">
                            @error('nama')
                    ...
                    <div class="mb-3">
                        <label for="tanggal_pengaduan">Tanggal</label>
                        <div class="mt-2 w-full">
                            <input id="tanggal_pengaduan" name="tanggal_pengaduan" type="date" readonly class="w-full rounded-md border py-1 px-4 text-gray-900">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div>
                        <div>Upload Bukti <span class="text-red-500 text-lg">*</span></div>
                        <div class="mt-2 w-full border-2 border-dashed rounded-lg flex flex-col items-center" style="font-family: Inter">
                            ...
                            <label for="bukti" class="border rounded-lg py-1 px-3 mt-3 mb-6">
                                Pilih Foto
                                <input type="file" id="bukti" name="bukti" style="display: none;">
                            </label>
                            @error('bukti')
