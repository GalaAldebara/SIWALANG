...
<main class="w-full h-full overflow-auto">
  <div class="flex flex-col items-center py-10 min-w-max">
      <div class="md:w-4/6 bg-primary p-3 text-white rounded-t-xl border-2 border-b-0 font-bold flex flex-row w-full">
      ...
      <form class="w-full md:w-4/6 flex flex-col items-start border-r border-l border-b min-w-[490px] rounded-b-xl"  action="{{ route('store.form-satu') }}" method="POST" enctype="multipart/form-data">
        @csrf
