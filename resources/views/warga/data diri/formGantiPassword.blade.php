...
<head>
    ...
    <title>Ganti Password | Data Diri</title>
          ...
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col box-sizing-border">
            ...
            <div class="bg-[#FFFFFF] flex flex-col p-[30px_27px_30px_27px] w-[fit-content] box-sizing-border">
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                ...
                <div class="rounded-[8px] border-[1px_solid_#EBEBEB] bg-[rgba(27,27,27,0.1)] p-[12.5px_15px_12.5px_15px] w-[fit-content] box-sizing-border">
                  <span class="break-words font-Asap font-normal text-[20px] leading-[1.2] text-[rgba(27,27,27,0.5)]">
                    347400022736785213
                  </span>
                </div>
              </div>
              <div class="m-[0_0_30px_0] flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="password-baru-sub-23"></span>
              ...
              <div class="flex flex-col w-[fit-content] box-sizing-border">
                <p class="m-[0_0_8px_0] self-start break-words font-'SF_Pro_Display','Roboto_Condensed' font-medium text-[20px] text-[#1B1B1B]">
                  <span class="verifikasi-password-baru-sub-23"></span>
