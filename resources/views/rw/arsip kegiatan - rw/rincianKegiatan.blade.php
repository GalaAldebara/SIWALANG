...
<body>
    <div class="bg-[#FFFFFF] flex flex-col items-center w-[1300px] box-sizing-border">
        <div class="bg-[url('../img/DesaLangLang.png')] bg-[50%_50%] bg-cover bg-no-repeat relative m-[0_0_50px_0] w-[1300px] h-[427px]">
          ...
          <div class="absolute left-[110px] top-[32.3px] right-[110px] flex flex-col items-end box-sizing-border">
            ...
            <div class="flex flex-col w-[fit-content] box-sizing-border">
              <div class="rounded-[15px] bg-[#FFFFFF] m-[0_0_85px_0] flex flex-row justify-between p-[10px_59.2px_10px_39.1px] w-[1080px] box-sizing-border">
                ...
                <div class="relative m-[12px_0_25px_0] flex p-[13px_0_0_0] w-[313.9px] h-[fit-content] box-sizing-border">
                  <div class="relative flex flex-row justify-between w-[313.9px] h-[fit-content] box-sizing-border">
        ...
        <div class="m-[0_105.5px_50px_107.5px] flex box-sizing-border">
          <div class="rounded-[12px] border-[1px_solid_#EBEBEB] flex flex-col items-center p-[0_0_43px_0] box-sizing-border">
            <div class="border-b-[1px_solid_#EBEBEB] bg-[#2A6C12] m-[0_0_32.5px_0] flex flex-row p-[16px_0_15px_29px] w-[1087px] box-sizing-border">
            ...
            <div class="m-[0_34.5px_0_0] flex flex-col items-center w-[fit-content] box-sizing-border">
              <div class="m-[0_0_22.1px_76.4px] flex box-sizing-border">
                <span class="break-words font-Poppins font-bold text-[20px] leading-[1.105] text-[#232428]">
                  Kerja Bakti Bersama Warga RW.01
                </span>
              </div>
              <div class="m-[0_0_35.5px_0] flex box-sizing-border justify-center">
                <span class="break-words font-Asap font-normal text-[17px] leading-[1.3] text-[#232428]">
              ...
              <div class="m-[0_0_0_34.5px] flex flex-col w-[fit-content] box-sizing-border justify-center">
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row justify-between p-[0_0_8px_0] w-[420px] box-sizing-border">
                  <span class="m-[0_12px_0_0] w-[68px] break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    Hari
                  </span>
                  <span class="break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    :
                  </span>
                  <span class="break-words font-Asap font-bold text-[16px] leading-[1.5] text-[#232428]">
                    Minggu
                  </span>
                </div>
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] flex flex-row p-[8px_0_8px_0] w-[420px] box-sizing-border">
                  <span class="m-[0_23.4px_0_0] break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    Tanggal
                  </span>
                  <span class="m-[0_23.8px_0_0] break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    :
                  </span>
                  <span class="break-words font-Asap font-bold text-[16px] leading-[1.5] text-[#232428]">
                    10 Maret 2024
                ...
                <div class="border-b-[1px_solid_rgba(0,0,0,0.06)] m-[0_0_8px_0] flex flex-row justify-between p-[8px_0_8px_0] w-[420px] box-sizing-border">
                  <span class="m-[0_12px_0_0] w-[67px] break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    Jam   
                  </span>
                  <span class="break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    :
                ...
                <div class="flex flex-row justify-between self-start w-[341px] box-sizing-border">
                  <span class="m-[0_12px_0_0] w-[67px] break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
                    Lokasi
                  </span>
                  <span class="break-words font-Asap font-normal text-[16px] leading-[1.5] text-[#232428]">
        ...
        <div class="bg-[#2A6C12] m-[0_0_0px_0] flex flex-col items-center p-[0_0_17.4px_0] w-[1300px] box-sizing-border">
