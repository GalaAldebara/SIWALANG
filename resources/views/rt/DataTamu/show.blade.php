          ...
          @else
            <div class="flex flex-row justify-center border-t w-full" style="font-family: Asap">
                <div class="grid grid-cols-[140px_30px_1fr] gap-y-2 my-7">
                  <p class="border-b-[1px]">Nama Tuan Rumah</p><p class="border-b-[1px]">:</p><p class="border-b-[1px] font-bold">{{ $pelaporan->nama_tuan_rumah }}</p>
                  <p class="border-b-[1px]">Nama Tamu</p><p class="border-b-[1px]">:</p><p class="border-b-[1px] font-bold">{{ $pelaporan->nama_tamu }}</p>
