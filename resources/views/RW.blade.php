        ...
        <div class="relative -top-14 w-full">
            <div class="flex justify-center">
                <nav class="flex flex-row flex-wrap gap-5 md:gap-9 justify-center items-center w-full md:w-3/6 text-xl px-4">
                    ...
                    <a class="rounded-md w-[150px] md:w-[250px] h-32 md:h-44 bg-gray-100"  href="{{ url('penerima_bansos/semua') }}">
                        <div class="p-5 flex flex-col items-center text-center">
                    ...
                    <a class="rounded-md w-[150px] md:w-[250px] h-32 md:h-44 bg-gray-100"  href="{{ url('data/kegiatan') }}">
                        <div class="p-5 flex flex-col items-center text-center">
