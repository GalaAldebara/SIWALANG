        ...
        <div class="relative -top-14 w-full">
            <div class="flex justify-center">
                <nav class="flex flex-row flex-wrap gap-9 justify-center items-center w-3/6 text-xl">
                    ...
                    <a class="rounded-md w-[250px] h-44" style="background-color:#f5f5f5" href="{{ url('penerima_bansos/semua') }}">
                        <div class="p-5 flex flex-col items-center text-center">
                    ...
                    <a class="rounded-md w-[250px] h-44" style="background-color:#f5f5f5" href="{{ url('data/kegiatan') }}">
                        <div class="p-5 flex flex-col items-center text-center">
                    ...
                    <a class="rounded-md w-[250px] h-44" style="background-color:#f5f5f5" href="{{ url('show-pdf') }}">
                        <div class="p-5 flex flex-col items-center text-center">
