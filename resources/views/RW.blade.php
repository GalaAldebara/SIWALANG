            ...
            <div class="absolute w-5/6">
                ...
                <nav class="bg-white w-full rounded-lg flex flex-col md:flex-row justify-between items-center min-w-max px-4">
                    ...
                    <div class="flex flex-row items-center py-2 md:py-0">
                        ...
                        <a class="group font-bold px-3 md:px-7 text-black transition-all duration-300 ease-in-out" href="{{ route('logout') }}">
                ...
                <header class="text-white/80 flex flex-col items-center mt-7 text-center">
                    ...
                    <p class="font-light pb-5 md:py-5 text-xs md:text-base hidden md:block" style="font-family: Asap">Portal pengelola kependudukan RW.01 Desa Lang-Lang</p>
                </header>
            </div>
        </div>
        ...
        <div class="relative -top-14 w-full">
            <div class="flex justify-center">
                <nav class="flex flex-row flex-wrap gap-5 md:gap-9 justify-center items-center w-full md:w-3/6 text-xl px-4">
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ route('RW.DataWarga.index') }}">
                    ...
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('data_tamu') }}">
                        <div class="flex flex-col items-center text-center">
                    ...
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5"  href="{{ url('penerima_bansos/semua') }}">
                        <div class="flex flex-col items-center text-center">
                    ...
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5"  href="{{ url('data/kegiatan') }}">
                        <div class="flex flex-col items-center text-center">
                    ...
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('RW-Keuangan') }}">
                        <div class="flex flex-col items-center text-center">
