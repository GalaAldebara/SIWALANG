...
<body>
    <div class="h-screen">
            ...
            <div class="absolute w-5/6">
                ...
                <nav class="bg-white w-full rounded-lg flex felx-row justify-between min-w-max">
                    ...
                    <div class="flex flex-row items-center px-7 py-6">
                        ...
                        <a class="relative group font-bold px-4 md:px-7 text-xs md:text-base text-black transition-all duration-300 ease-in-out" href="{{ url('auth/logout') }}" >
                            <span class="bg-gradient-to-r from-black to-black bg-[length:0%_2px] bg-left-bottom bg-no-repeat transition-all duration-500 ease-out group-hover:bg-[length:100%_2px]" style="font-family: Asap">
                                LOGOUT
                            </span>
        ...
        <div class="relative -top-14 w-full">
            <div class="flex justify-center">
                <nav class="flex flex-row flex-wrap gap-x-4 gap-y-5 md:gap-9 justify-center items-center w-full md:w-5/6 text-base md:text-xl">
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('data_diri') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Informasi personal data kependudukan</p>
                        </div>
                    </a>
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('show-pdf') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Pengajuan surat pengantar</p>
                        </div>
                    </a>
                    <button class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40 {{ $status != 'Selesai' ? 'cursor-not-allowed' : '' }}" id="pengajuan-bansos-link" style="background-color:#f5f5f5">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Pengajuan penerima bantuan sosial</p>
                        </div>
                    </button>
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('kegiatan/agenda') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Agenda / Jadwal kegiatan warga mendatang</p>
                        </div>
                    </a>
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('pelaporan-tamu') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Pelaporan adanya tamu dari luar desa yang menginap</p>
                        </div>
                    </a>
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('pengaduan') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Pengaduan permasalahan yang terjadi di lingkungan warga</p>
                        </div>
                    </a>
                    <a class="flex justify-center items-center rounded-md w-40 md:w-60 h-32 md:h-40" style="background-color:#f5f5f5" href="{{ url('kegiatan/arsip') }}">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-xs text-gray-500 hidden md:block">Arsip dokumentasi kegiatan warga bersama</p>
                        </div>
                    </a>
                </nav>
            </div>
    ...
    @if($status == 'Selesai')
        <script>
            document.getElementById('pengajuan-bansos-link').addEventListener('click', function() {
                window.location.href = "{{ url('pengajuan_bansos') }}";
            });
        </script>
    @else
        <script>
            document.getElementById('pengajuan-bansos-link').addEventListener('click', function() {
                Swal.fire({
                    icon: 'warning',
                    title: 'Akses Ditolak',
                    text: 'Data Diri Anda belum selesai atau belum Terverifikasi. Anda tidak dapat mengajukan Bansos saat ini.',
